...
export const FormLeft: FC = () => {
  return (
    <div className="lg:flex hidden justify-between flex-col items-start w-1/2 rounded-[10px] bg-accent p-10 bg-[url('/bg-umbrella.svg')] bg-no-repeat bg-right-bottom ">
      <div>
        <h2 className="text-7xl font-medium mb-5 tracking-[-4.32px]">
          Оставьте заявку
        </h2>
        <p className="leading-4 w-80">
